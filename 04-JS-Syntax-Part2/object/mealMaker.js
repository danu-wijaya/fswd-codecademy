...
menu.addDishToCourse("appetizers", "fries", 3.0);

menu.addDishToCourse("mains", "steak", 12.0);
menu.addDishToCourse("mains", "salmon", 11.0);
menu.addDishToCourse("mains", "tofi", 9.0);

menu.addDishToCourse("desserts", "ice cream", 3.0);
menu.addDishToCourse("desserts", "coffe", 4.0);
menu.addDishToCourse("desserts", "cake", 6.0);
