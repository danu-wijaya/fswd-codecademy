...
const declineEverything = (myArray) => {
  myArray.forEach(politelyDecline);
};

declineEverything(veggies);

const acceptEverything = (myArray) => {
  myArray.forEach((accept) =>
    console.log(`Ok, I guess I will eat some ${accept}.`)
  );
};
