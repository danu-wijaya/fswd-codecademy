...
const myNumbers = [12, 55, 356, 6575, 245];
for (const number of myNumbers) {
  console.log(number);
}

const names = "kamandanu";
for (const name of names) {
  console.log(name);
}

const city = ["jakarta", "bekasi", "bandung", "jogja"];
for (const place of city) {
  if (place === "bandung") {
    break;
  }
  console.log("this is use break :" + place);
}
...
for (const place of city) {
  ...
  console.log("this is use continue :" + place);
}
//////////////////////////////////////////////////
/*
